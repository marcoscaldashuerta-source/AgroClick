...
urlpatterns = [
    ...
    path('vendedor/mis-datos/', views.mis_datos_vendedor, name='mis_datos_vendedor'),
    ...
    path('eliminar-productos-seleccionados/', views.eliminar_productos_seleccionados, name='eliminar_productos_seleccionados'),
    # Rutas del carrito
    ...
    path('historial-registros/', views.historial_registros, name='historial_registros'),
]